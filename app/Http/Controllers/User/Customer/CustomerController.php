...
class CustomerController extends Controller
{
    public function index()
    {
        ...
        // dd($locations);
        return view('user.customer.index', compact('customers','locations'));
    }
    ...
    public function profile($id)
    {
        ...
        return view('user.customer.profile', compact('user', 'locations', 'response', 'contacts'));
    }
    ...
    public function map($id)
    {
        ...
        return view('user.customer.map', compact('user', 'groups', 'response'));
    }
