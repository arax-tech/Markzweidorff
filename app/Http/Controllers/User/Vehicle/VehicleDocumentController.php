...
class VehicleDocumentController extends Controller
{
    public function index($id)
    {
        ...
        $documents = VehicleDocument::where('user_id', $id)->get();
        return view('user.vehicle.document.index', compact('documents', 'user'));
    }
    ...
    public function wiki($id)
    {
        ...
        // dd($documents);
        return view('user.vehicle.list', compact('documents', 'user'));
    }
