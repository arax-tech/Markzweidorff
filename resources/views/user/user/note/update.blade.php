        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ url('/user/note/update/'.$user->id.'/'.$note->id) }}" enctype="multipart/form-data">
                            @csrf
                     ...
                     <div class="card-footer">
                        <a class="btn btn-sm" style="background-color: #8A8A8A; color: #fff;" href="{{ url('/user/note/'.$user->id.'/') }}">Annuller</a> 
