                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" action="{{ url('user/note/store/'.$user->id) }}">
                                                @csrf
                                                ...
                                                {{ $note->title }}
                                                  ...
                                                  <span class="float-end">  
                                                     @if (in_array("All", $permission) OR in_array("UserNoteUpdate", $permission) AND auth::user()->id != $user->id)
                                                       <a class="btn btn-datatable btn-icon btn-transparent-dark me-2" href="{{ url('/user/note/edit/'.$user->id.'/'.$note->id) }}" ><i data-feather="edit"></i></a>
                                                    ...
                                                    @if (in_array("All", $permission) OR in_array("UserNoteDelete", $permission) AND auth::user()->id != $user->id)
                                                       <a onclick="return confirm('Er du sikker på at du vil slette denne note ?')" class="btn btn-datatable btn-icon btn-transparent-dark" href="{{ url('/user/note/delete/'.$note->id) }}"><i data-feather="trash-2"></i></a>
