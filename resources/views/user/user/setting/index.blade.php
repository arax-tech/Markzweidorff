    ...
    <div class="container-fluid px-4 mt-4">
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                @endphp
                <form method="post" action="{{ url('/user/setting/permission/update/'.$user->id) }}">
                                    ...
                                    <table class="table table-striped table-hover mb-0">
                                        ...
                                        <tbody>
                                             <tr>
                                                ...
                                                <td>
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" id="NewsView" value="NewsView" @if (in_array("NewsView", $permission)) checked  @endif type="checkbox" name="permission[]" />
                                                        <label class="form-check-label" for="NewsView"></label>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" id="NewsCreate" value="NewsCreate" @if (in_array("NewsCreate", $permission)) checked  @endif type="checkbox" name="permission[]" />
                                                        <label class="form-check-label" for="NewsCreate"></label>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" id="NewsUpdate" value="NewsUpdate" @if (in_array("NewsUpdate", $permission)) checked  @endif type="checkbox" name="permission[]" />
                                                        <label class="form-check-label" for="NewsUpdate"></label>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" id="NewsDelete" value="NewsDelete" @if (in_array("NewsDelete", $permission)) checked  @endif type="checkbox" name="permission[]" />
                                                        <label class="form-check-label" for="NewsDelete"></label>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                ...
                                <div class="table-responsive table-billing-history">
                                    <table class="table table-striped table-hover mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td width="40%" valign="middle">MiniSite</td>
                                                <td>
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" id="MiniSiteView" value="MiniSiteView" @if (in_array("MiniSiteView", $permission)) checked  @endif type="checkbox" name="permission[]" />
                                                        <label class="form-check-label" for="MiniSiteView"></label>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" id="MiniSiteCreate" value="MiniSiteCreate" @if (in_array("MiniSiteCreate", $permission)) checked  @endif type="checkbox" name="permission[]" />
                                                        <label class="form-check-label" for="MiniSiteCreate"></label>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" id="MiniSiteUpdate" value="MiniSiteUpdate" @if (in_array("MiniSiteUpdate", $permission)) checked  @endif type="checkbox" name="permission[]" />
                                                        <label class="form-check-label" for="MiniSiteUpdate"></label>
                                                    </div>
                                                </td>

                                                <td>
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" id="MiniSiteDelete" value="MiniSiteDelete" @if (in_array("MiniSiteDelete", $permission)) checked  @endif type="checkbox" name="permission[]" />
                                                        <label class="form-check-label" for="MiniSiteDelete"></label>
                                                    </div>
                                                </td>
                                            </tr>
            ...
            <div class="col-lg-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive table-billing-history">
                            <form method="post" action="{{ url('/user/setting/app_access/'.$user->id) }}">
                                @csrf
                                ...
                                <table class="table table-striped table-hover mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="40%" valign="middle">Admin</td>
                                            <td>
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" id="Admin" value="Admin" @if (in_array("Admin", $app_permission)) checked  @endif type="checkbox" name="permission[]" />
                                                    <label class="form-check-label" for="Admin"></label>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="40%" valign="middle">PWA</td>
                                            <td>
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" id="PWA" value="PWA" @if (in_array("PWA", $app_permission)) checked  @endif type="checkbox" name="permission[]" />
                                                    <label class="form-check-label" for="PWA"></label>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="40%" valign="middle">PPJ</td>
                                            <td>
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" id="PPJ" value="PPJ" @if (in_array("PPJ", $app_permission)) checked  @endif type="checkbox" name="permission[]" />
                                                    <label class="form-check-label" for="PPJ"></label>
                                                </div>
                                            </td>
                                        </tr>
                                ...
                                <button type="submit" class="btn btn-success-soft text-success w-100 mt-3"><i class="me-1" data-feather="save"></i>&nbsp;Save</button>
                            </form>
                        </div>
