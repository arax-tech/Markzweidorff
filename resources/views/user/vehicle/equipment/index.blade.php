                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" action="{{ url('customer/equipment/store/'.$user->id) }}">
                                                @csrf
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if (in_array("All", $permission) OR in_array("UserEquipmentDelete", $permission) AND auth::user()->id != $user->id)
                                                <a onclick="return confirm('Are you sure to delete ?')" class="btn btn-datatable btn-icon btn-transparent-dark" href="{{ url('/customer/equipment/delete/'.$equipment->id) }}"><i data-feather="trash-2"></i></a>
                                    ...
                                    <div class="modal fade" id="UpdateEquipment{{ $equipment->id }}">
                                        <div class="modal-dialog  modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form method="post" action="{{ url('customer/equipment/update/'.$equipment->id) }}">
                                                        @csrf
