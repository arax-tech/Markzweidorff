                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" action="{{ url('vehicle/document/store/'.$user->id) }}" enctype="multipart/form-data">
                                                @csrf
                                    ...
                                    <tr>
                                        ...
                                        @endphp
                                            ...
                                            @if (in_array("All", $permission) OR in_array("UserDocumentDelete", $permission) AND auth::user()->id != $user->id)
                                                <a onclick="return confirm('Er du sikker på at du vil slette dette dokument ?')" class="btn btn-datatable btn-icon btn-transparent-dark" href="{{ url('/vehicle/document/delete/'.$document->id) }}"><i data-feather="trash-2"></i></a>
                                    ...
                                    <div class="modal fade" id="UpdateDocument{{ $document->id }}">
                                        <div class="modal-dialog modal-lg  modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form method="post" action="{{ url('vehicle/document/update/'.$document->id) }}" enctype="multipart/form-data">
                                                        @csrf
