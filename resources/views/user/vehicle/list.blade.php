                        ...
                        <table class="table table-striped mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="small"><b>Alle dokumenter</b></td>
                                    <td class="small"><b>{{ count($documentRead) + count($documentsNotifications) - count($documents1) + count($documentUnRead) +count($documentReadUnderstood) + count($documentReadNotUnderstood) }}</b></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active pt-4" id="read-tab-pane" role="tabpanel" aria-labelledby="read-tab" tabindex="0">
