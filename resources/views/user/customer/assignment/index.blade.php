                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ url('customer/stamdata/assignment/store/'.$user->id) }}" method="POST">
                                                @csrf
                                              ...
                                              <div class="row gx-3 mb-3">
                                                ...
                                                <div class="row gx-3 mb-3">
                                                    ...
                                                    <div class="col-md-4">
                                                        <label class="small mb-1">Contact Person</label>
                                                        <select class="form-control" name="contact_person_id">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <a onclick="return confirm('are you sure to delete Assignment ?')" class="btn btn-datatable btn-icon btn-transparent-dark" href="{{ url('/customer/stamdata/assignment/delete/'.$assignment->id) }}"><i data-feather="trash-2"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <div class="modal fade" id="UpdateAssignment{{ $assignment->id }}">
                                            <div class="modal-dialog  modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ url('customer/stamdata/assignment/update/'.$assignment->id) }}"  method="POST">
                                                            @csrf
                                                                    ...
                                                                    <select class="form-control" name="contact_person_id">
                                                                        ...
                                                                        @foreach ($contacts as $contact)
                                                                            <option value="{{ $contact->id }}"
                                                                                @if ($assignment->contact_person_id == $contact->id)
                                                                                    selected 
                                                                                @endif
                                                                            >{{ $contact->name }}</option>
                                                                        @endforeach
