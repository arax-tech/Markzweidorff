        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ url('news/update/'.$new->id) }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control input" type="text" name="title" value="{{ $new->title }}" required />
                                </div>
                           
                                <div class="col-md-4">
                                    <label class="small mb-1">Date</label>
                                    <input class="form-control" type="date" name="date" value="{{ $new->date }}" required />
                                </div>
                            ...
                            <div class="row gx-3 mb-3">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="content" required>{{ $new->content }}</textarea>
                                </div>
                            </div>
                            <div class="row gx-3 mb-3">
                                <div class="col-md-12">
                                    <button type="submit" class="btn btn-primary"><i class="me-1" data-feather="plus"></i> &nbsp;Update</button>
                                </div>
                            </div>
                        </form>
                    </div>
